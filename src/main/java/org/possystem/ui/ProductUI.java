...
public class ProductUI {
    ...
    public ProductUI(){
        JFrame mainFrame = new JFrame("Product Management | POS System");
        ...
        String[] columns = {"ID", "Name" , "Category ID"};
        ...
        searchInput.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (searchInput.getText().isEmpty()) {
                    ...
                    String[][] searchData = productService.searchProduct(searchInput.getText());
        ...
        editBtn.addActionListener(e -> {
            ...
            if(jt.getSelectedRow()>=0){
                ...
                String categoryId = (String) jt.getValueAt(jt.getSelectedRow(), 2);

                new EditProductUI(id,name);
             }
        });
        ...
        deleteBtn.addActionListener(e -> {
            if(jt.getSelectedRow()>=0){
                String id = (String) jt.getValueAt(jt.getSelectedRow(),0);
                productService.deleteItem(Integer.valueOf(id));
